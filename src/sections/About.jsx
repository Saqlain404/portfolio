      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        {!isMobile ? (
          <div className="grid-default-color grid-2">
            ...
            >
              <p className="flex items-end text-3xl md:text-5xl text-gray-500">
                CODE IS CRAFT
              </p>
              <Card
          ...
          <div className=" grid-5 bg-gradient-to-bl from-amber-700/0 to-purple-700/20 backdrop-blur-md rounded-2xl border-0 shadow-lg p-6">
    ...
    <Frameworks />
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I&apos;m based in Delhi, and open to on-site or remote work worldwide.
            </p>
          </div>
